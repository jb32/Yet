...
class BaseVerifyMobileViewController: SegueViewController {
    ...
    override func viewDidLoad() {
        ...
        verifyCodeTextField.rx.textInput.text
            .map({ $0?.count == YepConfig.verifyCodeLength() })
        ...
        verifyMobileNumberPromptLabelTopConstraint.constant = Ruler.iPhoneVertical(30, 50, 60, 60, 60, 60).value
        verifyCodeTextFieldTopConstraint.constant = Ruler.iPhoneVertical(30, 40, 50, 50, 50, 50).value
        callMeButtonTopConstraint.constant = Ruler.iPhoneVertical(10, 20, 40, 40, 40, 40).value
    }
