...
func configureDynamicShortcuts() {
    ...
    do {
        if let realm = try? Realm() {
            ...
            let conversations = [a, b, c, d, e, f].compactMap({ $0 }).sorted(by: { $0.updatedUnixTime > $1.updatedUnixTime })
            ...
            for (index, conversation) in conversations.enumerated() {
                ...
                if let user = conversation.withFriend {
                    ...
                    let item = UIApplicationShortcutItem(
                        ...
                        userInfo: ["userID": user.userID as NSSecureCoding]
                    )
                    ...
                    let item = UIApplicationShortcutItem(
                        ...
                        userInfo: ["feedID": feed.feedID as NSSecureCoding]
                    )
