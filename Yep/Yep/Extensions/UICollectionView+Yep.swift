...
extension UICollectionView {
    ...
    func registerHeaderNibOf<T: UICollectionReusableView>(_: T.Type) {
        ...
        let nib = UINib(nibName: T.yep_nibName, bundle: nil)
        register(nib, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: T.yep_reuseIdentifier)
    }

    func registerFooterClassOf<T: UICollectionReusableView>(_: T.Type) {

        register(T.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionFooter, withReuseIdentifier: T.yep_reuseIdentifier)
    }
