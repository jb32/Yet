...
extension String {
    ...
    static var trans_titleCircleMembers: String {
        return NSLocalizedString("title.circleMembers", comment: "")
    }
    ...
    static var trans_promptNoMembers: String {
        return NSLocalizedString("prompt.no_members", comment: "")
    }
    ...
    static var trans_titleTopic: String {
        return NSLocalizedString("title.topic", comment: "")
    }
    
    static var trans_titleActivity: String {
        return NSLocalizedString("title.activity", comment: "")
    }
}
