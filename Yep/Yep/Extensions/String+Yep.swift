...
extension String {
    ...
    func yep_NSRangeFromRange(_ range: Range<Index>) -> NSRange {
        ...
        let begin = utf16view.distance(from: utf16view.startIndex, to: from!)
        let end = utf16view.distance(from: from!, to: to!)
        return NSMakeRange(begin, end)
    }
}
...
extension String {
    ...
    func yep_mentionWordInIndex(_ index: Int) -> (wordString: String, mentionWordRange: Range<Index>)? {
        ...
        let mentionWord = self[mentionWordRange]//substring(with: mentionWordRange)
...
extension String {
    ...
    func yep_highlightKeyword(_ keyword: String, withColor color: UIColor, baseFont: UIFont, baseColor: UIColor) -> NSAttributedString? {
        ...
        attributedString.addAttribute(NSAttributedString.Key.foregroundColor, value: baseColor, range: textRange)
        attributedString.addAttribute(NSAttributedString.Key.font, value: baseFont, range: textRange)
