...
extension UIStoryboard {
    ...
    static var yep_feeds: UIStoryboard {
        return UIStoryboard(name: "Feeds", bundle: nil)
    }
    ...
    struct Scene {
        ...
        static var activityVC: ActivityViewController {
            return UIStoryboard.yep_feeds.instantiateViewController(withIdentifier: "\(ActivityViewController.self)") as! ActivityViewController
        }
        
        static var feedsVc: FeedsViewController {
            return UIStoryboard.yep_feeds.instantiateViewController(withIdentifier: "\(FeedsViewController.self)") as! FeedsViewController
        }
    }
}
