...
final class ActivityIndicatorTitleView: UIView {
    ...
    func makeUI() {
        ...
        do {
            ...
            let constraintsH = NSLayoutConstraint.constraints(withVisualFormat: "H:|[label]|", options: NSLayoutConstraint.FormatOptions.alignAllCenterY, metrics: nil, views: views)
            let constraintsV = NSLayoutConstraint.constraints(withVisualFormat: "V:|[label]|", options: NSLayoutConstraint.FormatOptions.alignAllCenterY, metrics: nil, views: views)
        ...
        do {
            ...
            let constraintsH = NSLayoutConstraint.constraints(withVisualFormat: "H:|[activityIndicator]-[label]|", options: NSLayoutConstraint.FormatOptions.alignAllCenterY, metrics: nil, views: viewsDictionary)
            let constraintsV = NSLayoutConstraint.constraints(withVisualFormat: "V:|[activityIndicator]|", options: NSLayoutConstraint.FormatOptions.alignAllCenterY, metrics: nil, views: viewsDictionary)
