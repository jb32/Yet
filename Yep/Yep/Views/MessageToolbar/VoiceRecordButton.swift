...
final class VoiceRecordButton: UIView {
    ...
    fileprivate func makeUI() {
        ...
        let constraintsH = NSLayoutConstraint.constraints(withVisualFormat: "H:|-10-[leftVoiceImageView(20)][titleLabel][rightVoiceImageView(==leftVoiceImageView)]-10-|", options: NSLayoutConstraint.FormatOptions.alignAllCenterY, metrics: nil, views: views)
