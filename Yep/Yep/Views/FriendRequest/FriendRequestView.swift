...
final class FriendRequestView: UIView {
    ...
    func baseButton() -> UIButton {
        let button = UIButton()
        button.setContentHuggingPriority(UILayoutPriority(rawValue: 300), for: NSLayoutConstraint.Axis.horizontal)
    ...
    @objc func tryAddAction() {
        addAction?(self)
    }

    @objc func tryAcceptAction() {
        acceptAction?(self)
    }

    @objc func tryRejectAction() {
        rejectAction?(self)
    }
    ...
    func makeUI() {
        ...
        case .add:
            ...
            addButton.setContentCompressionResistancePriority(UILayoutPriority.required, for: .horizontal)
        ...
        case .consider:
            ...
            acceptButton.setContentCompressionResistancePriority(UILayoutPriority.required, for: .horizontal)
            ...
            rejectButton.setContentCompressionResistancePriority(UILayoutPriority.required, for: .horizontal)
