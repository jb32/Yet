...
final class SubscribeView: UIView {
    ...
    func makeUI() {
        ...
        do {
            ...
            let constraintsH = NSLayoutConstraint.constraints(withVisualFormat: "H:|-[iconImageView]-[promptLabel]-(>=10)-[subscribeButton]-[dismissButton]-(9)-|", options: NSLayoutConstraint.FormatOptions.alignAllCenterY, metrics: nil, views: views)
