...
final class YepRefreshView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        leafShape1.transform = CATransform3DMakeRotation(CGFloat(-CGFloat.pi / 6), 0.0, 0.0, 1.0)
        leafShape2.transform = CATransform3DMakeRotation(CGFloat(CGFloat.pi / 2), 0.0, 0.0, 1.0)
        leafShape3.transform = CATransform3DMakeRotation(CGFloat(-CGFloat.pi + CGFloat.pi / 6), 0.0, 0.0, 1.0)
