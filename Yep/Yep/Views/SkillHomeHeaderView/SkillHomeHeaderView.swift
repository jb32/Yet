...
//        headerImageView.addGestureRecognizer(tap)
        ...
        masterButton.addTarget(self, action: #selector(tap), for: .touchUpInside)
        learningButton.addTarget(self, action: #selector(tap), for: .touchUpInside)
    }
...
//        masterButton.frame = CGRect(x: 0, y: self.frame.height - YepConfig.skillHomeHeaderButtonHeight, width: self.frame.size.width/2.0, height: YepConfig.skillHomeHeaderButtonHeight)
        masterButton.frame = CGRect(x: 0, y: 0, width: self.frame.size.width/2.0, height: YepConfig.skillHomeHeaderButtonHeight)
...
//        learningButton.frame = CGRect(x: masterButton.frame.size.width, y: self.frame.height - YepConfig.skillHomeHeaderButtonHeight, width: self.frame.size.width/2.0, height: YepConfig.skillHomeHeaderButtonHeight)
        learningButton.frame = CGRect(x: masterButton.frame.size.width, y: 0, width: self.frame.size.width/2.0, height: YepConfig.skillHomeHeaderButtonHeight)
