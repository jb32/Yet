...
final class FeedGithubRepoContainerView: UIView {
    ...
    fileprivate func makeUI() {
        ...
        iconImageView.setContentCompressionResistancePriority(UILayoutPriority.defaultHigh, for: .horizontal)
        accessoryImageView.setContentCompressionResistancePriority(UILayoutPriority.defaultHigh, for: .horizontal)
