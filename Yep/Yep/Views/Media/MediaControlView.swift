...
final class MediaControlView: UIView {
    ...
    lazy var playButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(MediaControlView.playOrPause), for: UIControl.Event.touchUpInside)
        return button
    }()
    ...
    lazy var shareButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(MediaControlView.share), for: UIControl.Event.touchUpInside)
        return button
    }()
