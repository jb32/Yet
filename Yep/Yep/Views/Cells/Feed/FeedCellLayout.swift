...
struct FeedCellLayout {
    ...
    init(feed: DiscoveredFeed) {
        ...
        let _rect1 = feed.body.boundingRect(with: CGSize(width: FeedBasicCell.messageTextViewMaxWidth, height: CGFloat.greatestFiniteMagnitude), options: [.usesLineFragmentOrigin, .usesFontLeading], attributes: YepConfig.FeedBasicCell.textAttributes, context: nil)
