...
class FeedBasicCell: UITableViewCell {
    ...
    class func heightOfFeed(_ feed: DiscoveredFeed) -> CGFloat {
        ...
        let rect = feed.body.boundingRect(with: CGSize(width: FeedBasicCell.messageTextViewMaxWidth, height: CGFloat.greatestFiniteMagnitude), options: [.usesLineFragmentOrigin, .usesFontLeading], attributes: YepConfig.FeedBasicCell.textAttributes, context: nil)
    ...
    @objc func tapSkill(_ sender: AnyObject) {
