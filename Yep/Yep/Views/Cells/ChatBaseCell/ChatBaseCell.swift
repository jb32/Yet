...
class ChatBaseCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(ChatBaseCell.menuWillShow(_:)), name: UIMenuController.willShowMenuNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(ChatBaseCell.menuWillHide(_:)), name: UIMenuController.willHideMenuNotification, object: nil)
    }
    ...
    @objc func deleteMessage(_ object: UIMenuController?) {
        deleteMessageAction?()
    }

    @objc func reportMessage(_ object: UIMenuController?) {
        reportMessageAction?()
    }
}
