...
final class MessageLoadingProgressView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        let baseCircle = UIBezierPath(arcCenter: center, radius: radius, startAngle: 0, endAngle: CGFloat.pi * 2, clockwise: true)
        ...
        let progressArc = UIBezierPath(arcCenter: center, radius: radius, startAngle: -CGFloat.pi / 2, endAngle: CGFloat.pi * 2 * CGFloat(progress) - CGFloat.pi / 2, clockwise: true)
