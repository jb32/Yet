...
open class DatePickerDialog: UIView {
    ...
    open func show(_ title: String,
        ...
        doneButton.setBackgroundImage(UIImage.imageWithColor(UIColor.skillMasterColor()), for: .normal);
        if showCancelButton {
            self.cancelButton.setTitle(cancelButtonTitle, for: .normal)
            cancelButton.setTitleColor(UIColor.skillMasterColor(), for: .normal)
        }
    ...
    private func createContainerView() -> UIView {
        ...
        let dialogSize = CGSize(width: YepConfig.getScreenRect().width - 40, height: 230 + kDefaultButtonHeight + kDefaultButtonSpacerHeight)
...
//                           UIColor(red: 218/255, green: 218/255, blue: 218/255, alpha: 1).cgColor]
        ...
        //Title
        self.titleLabel = UILabel(frame: CGRect(x: 10, y: 10, width: YepConfig.getScreenRect().width - 40 - 20, height: 30))
        self.titleLabel.textAlignment = .center
        self.titleLabel.textColor = UIColor.skillMasterColor()//self.textColor
    ...
    fileprivate func configuredDatePicker() -> UIDatePicker {
        ...
        datePicker.setValue(UIColor.skillMasterColor(), forKeyPath: "textColor")
        datePicker.autoresizingMask = .flexibleRightMargin
        datePicker.frame.size.width = YepConfig.getScreenRect().width - 40
