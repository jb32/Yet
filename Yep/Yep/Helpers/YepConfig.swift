...
final class YepConfig {
    ...
    static let skillHomeHeaderViewHeight: CGFloat = 114.0 / 2

    static let skillHomeHeaderButtonHeight: CGFloat = 50.0

    static let maxFeedTextLength: Int = 300

    static let termsURLString = "http://www.chd.edu.cn"
    static let appURLString = "itms-apps://itunes.apple.com/app/id" + "8888888888"
    ...
    struct NotificationName {
        ...
        static let groupMembers = Notification.Name(rawValue: "Seattle.Notification.GroupMembers")
    }
    ...
    struct EditProfile {
        ...
        static let infoFont = UIFont.systemFont(ofSize: 15, weight: UIFont.Weight.light)
    ...
    struct SearchedItemCell {
        ...
        static let nicknameFont = UIFont.systemFont(ofSize: 14, weight: UIFont.Weight.medium)
    ...
    struct ChatCell {
        ...
        static let textAttributes: [NSAttributedString.Key: NSObject] = [
            NSAttributedString.Key.font: UIFont.chatTextFont(),
        ]
    }
    ...
    struct FeedBasicCell {
        static let textAttributes: [NSAttributedString.Key: NSObject] = [
            NSAttributedString.Key.font: UIFont.feedMessageFont(),
        ]

        static let skillTextAttributes: [NSAttributedString.Key: NSObject] = [
            NSAttributedString.Key.font: UIFont.feedSkillFont(),
        ]

        static let voiceTimeLengthTextAttributes: [NSAttributedString.Key: NSObject] = [
            NSAttributedString.Key.font: UIFont.feedVoiceTimeLengthFont(),
        ]

        static let bottomLabelsTextAttributes: [NSAttributedString.Key: NSObject] = [
            NSAttributedString.Key.font: UIFont.feedBottomLabelsFont(),
        ]
    }
    ...
    struct Feedback {
        static let bottomMargin: CGFloat = Ruler.iPhoneVertical(10, 20, 40, 40, 40, 40).value
    }
