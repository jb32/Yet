    ...
    class func showActivityIndicatorWhileBlockingUI(_ blockingUI: Bool) {
        ...
        SafeDispatch.async {
            if
                ...
                UIView.animate(withDuration: 0.1, delay: 0.0, options:UIView.AnimationOptions(rawValue: 0), animations: {
                        ...
                        UIView.animate(withDuration: 0.2, delay: 0.0, options: UIView.AnimationOptions(rawValue: 0), animations: {
