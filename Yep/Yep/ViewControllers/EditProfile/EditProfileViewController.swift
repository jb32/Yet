...
final class EditProfileViewController: SegueViewController {
    ...
    fileprivate let infoAttributes = [NSAttributedString.Key.font: YepConfig.EditProfile.infoFont]
    ...
    fileprivate func heightOfCellForMoreInfo(_ info: String) -> CGFloat {
        ...
        let rect: CGRect = info.boundingRect(with: CGSize(width: introLabelMaxWidth, height: .greatestFiniteMagnitude), options: [.usesLineFragmentOrigin, .usesFontLeading], attributes: infoAttributes, context: nil)
...
extension EditProfileViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingImage image: UIImage!, editingInfo: [AnyHashable: Any]!) {
        ...
        let imageData = image.jpegData(compressionQuality: Config.avatarCompressionQuality)
