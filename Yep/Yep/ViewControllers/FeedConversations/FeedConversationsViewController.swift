...
final class FeedConversationsViewController: SegueViewController {
    ...
    deinit {
        ...
        feedConversationsNotificationToken?.invalidate()
    ...
    override func viewDidLoad() {
        ...
        feedConversationsNotificationToken = feedConversations.observe({ [weak self] (change: RealmCollectionChange) in
    ...
    @objc func reloadFeedConversationsTableView() {
