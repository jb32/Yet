...
extension ConversationViewController {
    ...
    func makeFeedView(for feed: ConversationFeed) -> FeedView {
        ...
        feedView.tapMembersAction = { [weak self] in
            self?.performSegue(withIdentifier: "showGroupMembers", sender: nil)
        }
        ...
        let top = NSLayoutConstraint(item: feedView, attribute: .top, relatedBy: .equal, toItem: view, attribute: .top, multiplier: 1.0, constant: y)
