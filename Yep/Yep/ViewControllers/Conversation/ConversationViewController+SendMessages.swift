...
extension ConversationViewController {
    ...
    func sendImage(_ image: UIImage) {
        ...
        let imageData = image.jpegData(compressionQuality: YepConfig.messageImageCompressionQuality())!
    ...
    func sendVideo(at videoURL: URL) {
        ...
        if let image = thumbnailImageOfVideoInVideoURL(videoURL) {
            ...
            if let thumbnail = image.resizeToSize(thumbnailSize, withInterpolationQuality: .low),
                ...
                let data = blurredThumbnail.jpegData(compressionQuality: 0.7)!
            ...
            thumbnailData = image.jpegData(compressionQuality: YepConfig.messageImageCompressionQuality())
        }
