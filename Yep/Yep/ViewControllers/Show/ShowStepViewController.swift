...
class ShowStepViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        titleLabelBottomConstraint.constant = Ruler.iPhoneVertical(20, 30, 30, 30, 30, 30).value
        subTitleLabelBottomConstraint.constant = Ruler.iPhoneVertical(120, 140, 160, 180, 180, 180).value
    }
