...
final class SearchFeedsViewController: BaseSearchViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(SearchFeedsViewController.didRecieveMenuWillShowNotification(_:)), name: UIMenuController.willShowMenuNotification, object: nil)

        NotificationCenter.default.addObserver(self, selector: #selector(SearchFeedsViewController.didRecieveMenuWillHideNotification(_:)), name: UIMenuController.willHideMenuNotification, object: nil)
...
extension SearchFeedsViewController: UISearchBarDelegate {
    ...
    fileprivate func updateSearchResultsWithText(_ searchText: String) {
        ...
        searchFeedsWithKeyword(searchText, mode: .initer)
    }
}
