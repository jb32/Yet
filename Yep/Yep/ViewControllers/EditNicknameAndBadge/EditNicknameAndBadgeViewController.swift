...
final class EditNicknameAndBadgeViewController: UITableViewController {
        ...
        badgeViews.forEach {
            ...
            $0.tapAction = { badgeView in
                ...
                if self.badgeEnabledImageView.isHidden {
                    ...
                    UIView.animate(withDuration: 0.2, delay: 0.0, usingSpringWithDamping: 0.65, initialSpringVelocity: 0.0, options: UIView.AnimationOptions(rawValue: 0), animations: { [weak self] in
    ...
    fileprivate func badgeEnabledImageViewAppearInCenter(_ center: CGPoint) {
        ...
        UIView.animate(withDuration: 0.2, delay: 0.0, usingSpringWithDamping: 0.7, initialSpringVelocity: 0.0, options: UIView.AnimationOptions(rawValue: 0), animations: { [weak self] in
