...
final class MediaPreviewViewController: UIViewController {
    ...
    @objc func tryDismiss() {
        ...
        let finishDismissAction: () -> Void = { [weak self] in
            ...
            mediaPreviewWindow.windowLevel = UIWindow.Level.normal
        ...
        case .messageType(let message):
            ...
            case .video:
                ...
                if let videoFileURL = message.videoFileURL {
                    ...
                    player.addPeriodicTimeObserver(forInterval: CMTimeMakeWithSeconds(0.1, preferredTimescale: Int32(NSEC_PER_SEC)), queue: nil, using: { [weak self] time in
