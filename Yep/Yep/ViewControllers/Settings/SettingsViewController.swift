...
final class SettingsViewController: BaseViewController {
    ...
    fileprivate let introAttributes = [NSAttributedString.Key.font: YepConfig.Settings.introFont]
...
extension SettingsViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        case .user:
            ...
            let rect = introduction.boundingRect(with: CGSize(width: introLabelMaxWidth, height: .greatestFiniteMagnitude), options: [.usesLineFragmentOrigin, .usesFontLeading], attributes: introAttributes, context: nil)
