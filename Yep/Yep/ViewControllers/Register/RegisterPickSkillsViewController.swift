...
final class RegisterPickSkillsViewController: BaseViewController {
    ...
    var isDirty = false {
        didSet {
            if !isRegister {
                let backBarButtonItem = UIBarButtonItem(barButtonSystemItem: UIBarButtonItem.SystemItem.cancel, target: self, action: #selector(RegisterPickSkillsViewController.cancel))
    ...
    let skillTextAttributes = [NSAttributedString.Key.font: UIFont.skillTextLargeFont()]
    ...
    override func viewDidLoad() {
        ...
        let doneBarButtonItem = UIBarButtonItem(barButtonSystemItem: UIBarButtonItem.SystemItem.done, target: self, action: #selector(RegisterPickSkillsViewController.saveSkills(_:)))
...
extension RegisterPickSkillsViewController: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView!, layout collectionViewLayout: UICollectionViewLayout!, sizeForItemAtIndexPath indexPath: IndexPath!) -> CGSize {
        ...
        let rect = skillString.boundingRect(with: CGSize(width: .greatestFiniteMagnitude, height: SkillSelectionCell.height), options: [.usesLineFragmentOrigin, .usesFontLeading], attributes: skillTextAttributes, context: nil)
