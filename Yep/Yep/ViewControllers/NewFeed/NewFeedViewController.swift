...
final class NewFeedViewController: SegueViewController {
    ...
    override func viewDidLoad() {
        ...
        println("feedsViewController: \(feedsViewController ?? UIViewController())")
    ...
    func post(again: Bool) {
        ...
        case .default:
            ...
            mediaImages.forEach({ image in
                ...
                if let image = image.resizeToSize(fixedSize, withInterpolationQuality: .default), let imageData = image.jpegData(compressionQuality: 0.95) {
                ...
                if let strongSelf = self {
                    ...
                    for i in 0..<strongSelf.mediaImages.count {
                        ...
                        do {
                            ...
                            let scaledData = image.jpegData(compressionQuality: 1.0)
