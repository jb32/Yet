...
final class AboutViewController: SegueViewController {
    ...
    fileprivate let rowHeight: CGFloat = Ruler.iPhoneVertical(45, 50, 55, 60, 60, 60).value
    ...
    override func viewDidLoad() {
        ...
        appLogoImageViewTopConstraint.constant = Ruler.iPhoneVertical(0, 20, 40, 60, 60, 60).value
        appNameLabelTopConstraint.constant = Ruler.iPhoneVertical(10, 20, 20, 20, 20, 20).value
...
extension AboutViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case Row.share.rawValue:
            let yepURL = URL(string: "http://www.chd.edu.cn")!
