...
open class Avatar: Object {
    @objc open dynamic var avatarURLString: String = ""
    @objc open dynamic var avatarFileName: String = ""

    @objc open dynamic var roundMini: Data = Data() // 60
    @objc open dynamic var roundNano: Data = Data() // 40
...
open class UserSkillCategory: Object {
    @objc open dynamic var skillCategoryID: String = ""
    @objc open dynamic var name: String = ""
    @objc open dynamic var localName: String = ""
...
open class UserSkill: Object {
    ...
    @objc open dynamic var category: UserSkillCategory?
    ...
    @objc open dynamic var skillID: String = ""
    @objc open dynamic var name: String = ""
    @objc open dynamic var localName: String = ""
    @objc open dynamic var coverURLString: String = ""
...
open class UserSocialAccountProvider: Object {
    @objc open dynamic var name: String = ""
    @objc open dynamic var enabled: Bool = false
}

open class UserDoNotDisturb: Object {
    @objc open dynamic var isOn: Bool = false
    @objc open dynamic var fromHour: Int = 22
    @objc open dynamic var fromMinute: Int = 0
    @objc open dynamic var toHour: Int = 7
    @objc open dynamic var toMinute: Int = 30
...
open class User: Object {
    ...
    @objc open dynamic var username: String = ""
    @objc open dynamic var nickname: String = ""
    @objc open dynamic var introduction: String = ""
    @objc open dynamic var avatarURLString: String = ""
    @objc open dynamic var avatar: Avatar?
    @objc open dynamic var badge: String = ""
    @objc open dynamic var blogURLString: String = ""
    @objc open dynamic var blogTitle: String = ""

    open override class func indexedProperties() -> [String] {
        return ["userID"]
    }

    @objc open dynamic var createdUnixTime: TimeInterval = Date().timeIntervalSince1970
    @objc open dynamic var lastSignInUnixTime: TimeInterval = Date().timeIntervalSince1970

    @objc open dynamic var friendState: Int = UserFriendState.stranger.rawValue
    @objc open dynamic var friendshipID: String = ""
    @objc open dynamic var isBestfriend: Bool = false
    @objc open dynamic var bestfriendIndex: Int = 0

    open var canShowProfile: Bool {
        return friendState != UserFriendState.yep.rawValue
    }

    @objc open dynamic var longitude: Double = 0
    @objc open dynamic var latitude: Double = 0

    @objc open dynamic var notificationEnabled: Bool = true
    @objc open dynamic var blocked: Bool = false

    @objc open dynamic var doNotDisturb: UserDoNotDisturb?
...
open class Group: Object {
    @objc open dynamic var groupID: String = ""
    @objc open dynamic var groupName: String = ""
    @objc open dynamic var notificationEnabled: Bool = true
    @objc open dynamic var createdUnixTime: TimeInterval = Date().timeIntervalSince1970

    @objc open dynamic var owner: User?
    open var members = List<User>()

    @objc open dynamic var groupType: Int = GroupType.private.rawValue

    @objc open dynamic var withFeed: Feed?

    @objc open dynamic var includeMe: Bool = false
...
open class Coordinate: Object {
    @objc open dynamic var latitude: Double = 0    // 合法范围 (-90, 90)
    @objc open dynamic var longitude: Double = 0   // 合法范围 (-180, 180)
...
open class SocialWorkGithubRepo: Object {
    @objc open dynamic var repoID: Int = 0
    @objc open dynamic var name: String = ""
    @objc open dynamic var fullName: String = ""
    @objc open dynamic var URLString: String = ""
    @objc open dynamic var repoDescription: String = ""

    @objc open dynamic var createdUnixTime: TimeInterval = Date().timeIntervalSince1970
    @objc open dynamic var synced: Bool = false
...
open class SocialWorkDribbbleShot: Object {
    @objc open dynamic var shotID: Int = 0
    @objc open dynamic var title: String = ""
    @objc open dynamic var htmlURLString: String = ""
    @objc open dynamic var imageURLString: String = ""
    @objc open dynamic var shotDescription: String = ""
...
open class SocialWorkInstagramMedia: Object {
    @objc open dynamic var repoID: String = ""
    @objc open dynamic var linkURLString: String = ""
    @objc open dynamic var imageURLString: String = ""
...
open class MessageSocialWork: Object {
    @objc open dynamic var type: Int = MessageSocialWorkType.githubRepo.rawValue

    @objc open dynamic var githubRepo: SocialWorkGithubRepo?
    @objc open dynamic var dribbbleShot: SocialWorkDribbbleShot?
    @objc open dynamic var instagramMedia: SocialWorkInstagramMedia?
}

open class Message: Object {
    @objc open dynamic var messageID: String = ""

    @objc open dynamic var createdUnixTime: TimeInterval = Date().timeIntervalSince1970
    @objc open dynamic var updatedUnixTime: TimeInterval = Date().timeIntervalSince1970
    @objc open dynamic var arrivalUnixTime: TimeInterval = Date().timeIntervalSince1970

    @objc open dynamic var mediaType: Int = MessageMediaType.text.rawValue

    @objc open dynamic var textContent: String = ""
    ...
    @objc open dynamic var openGraphDetected: Bool = false
    @objc open dynamic var openGraphInfo: OpenGraphInfo?

    @objc open dynamic var coordinate: Coordinate?

    @objc open dynamic var attachmentURLString: String = ""
    @objc open dynamic var localAttachmentName: String = ""
    @objc open dynamic var thumbnailURLString: String = ""
    @objc open dynamic var localThumbnailName: String = ""
    @objc open dynamic var attachmentID: String = ""
    @objc open dynamic var attachmentExpiresUnixTime: TimeInterval = Date().timeIntervalSince1970 + (6 * 60 * 60 * 24) // 6天，过期时间s3为7天，客户端防止误差减去1天
    ...
    @objc open dynamic var mediaMetaData: MediaMetaData?

    @objc open dynamic var socialWork: MessageSocialWork?

    @objc open dynamic var downloadState: Int = MessageDownloadState.noDownload.rawValue
    @objc open dynamic var sendState: Int = MessageSendState.notSend.rawValue
    @objc open dynamic var readed: Bool = false
    @objc open dynamic var mediaPlayed: Bool = false // 音频播放过，图片查看过等
    @objc open dynamic var hidden: Bool = false // 隐藏对方消息，使之不再显示
    @objc open dynamic var deletedByCreator: Bool = false
    @objc open dynamic var blockedByRecipient: Bool = false
    open var isIndicator: Bool {
        return deletedByCreator || blockedByRecipient
    }

    @objc open dynamic var fromFriend: User?
    @objc open dynamic var conversation: Conversation?
...
open class Draft: Object {
    @objc open dynamic var messageToolbarState: Int = MessageToolbarState.default.rawValue
...
open class Conversation: Object {
    ...
    open var mentionInitUsers: [UsernamePrefixMatchedUser] {
        ...
        let users = messages.compactMap({ $0.fromFriend }).filter({ !$0.isInvalidated }).filter({ !$0.username.isEmpty && !$0.isMe })
    ...
    @objc open dynamic var type: Int = ConversationType.oneToOne.rawValue
    @objc open dynamic var updatedUnixTime: TimeInterval = Date().timeIntervalSince1970
    open var olderUpdatedUnixTime: TimeInterval {
        return updatedUnixTime - 30
    }

    @objc open dynamic var withFriend: User?
    @objc open dynamic var withGroup: Group?

    @objc open dynamic var draft: Draft?

    public let messages = LinkingObjects(fromType: Message.self, property: "conversation")

    @objc open dynamic var unreadMessagesCount: Int = 0
    @objc open dynamic var hasUnreadMessages: Bool = false
    @objc open dynamic var mentionedMe: Bool = false
    @objc open dynamic var lastMentionedMeUnixTime: TimeInterval = Date().timeIntervalSince1970 - 60*60*12 // 默认为此Conversation创建时间之前半天
    @objc open dynamic var hasOlderMessages: Bool = true
...
open class Attachment: Object {
    ...
    @objc open dynamic var metadata: String = ""
    @objc open dynamic var URLString: String = ""
}

open class FeedAudio: Object {

    @objc open dynamic var feedID: String = ""
    @objc open dynamic var URLString: String = ""
    @objc open dynamic var metadata: Data = Data()
...
open class OpenGraphInfo: Object {
    ...
    @objc open dynamic var URLString: String = ""
    @objc open dynamic var siteName: String = ""
    @objc open dynamic var title: String = ""
    @objc open dynamic var infoDescription: String = ""
    @objc open dynamic var thumbnailImageURLString: String = ""
...
open class Feed: Object {
    ...
    @objc open dynamic var feedID: String = ""
    @objc open dynamic var allowComment: Bool = true

    @objc open dynamic var createdUnixTime: TimeInterval = Date().timeIntervalSince1970
    @objc open dynamic var updatedUnixTime: TimeInterval = Date().timeIntervalSince1970

    @objc open dynamic var creator: User?
    @objc open dynamic var distance: Double = 0
    @objc open dynamic var messagesCount: Int = 0
    @objc open dynamic var body: String = ""

    @objc open dynamic var kind: String = FeedKind.text.rawValue
    open var attachments = List<Attachment>()
    @objc open dynamic var socialWork: MessageSocialWork?
    @objc open dynamic var audio: FeedAudio?
    @objc open dynamic var location: FeedLocation?
    @objc open dynamic var openGraphInfo: OpenGraphInfo?

    @objc open dynamic var skill: UserSkill?

    @objc open dynamic var group: Group?

    @objc open dynamic var deleted: Bool = false // 已被管理员或建立者删除
...
open class UserLocationName: Object {
    ...
    @objc open dynamic var userID: String = ""
    @objc open dynamic var locationName: String = ""
...
public func countOfConversationsInRealm(_ realm: Realm) -> Int {
    let msgs = realm.objects(Conversation.self).filter({ !$0.isInvalidated })
    return msgs.count
}
...
public func countOfUnreadMessagesInRealm(_ realm: Realm, withConversationType conversationType: ConversationType) -> Int {
    ...
    case .group: // Public for now
        ...
        let count: Int = realm.objects(Group.self).filter(predicate).map({ $0.conversation }).compactMap({ $0 }).filter({ !$0.isInvalidated }).map({ $0.hasUnreadMessages ? 1 : 0 }).reduce(0, +)
...
public func countOfUnreadMessagesInConversation(_ conversation: Conversation) -> Int {
    ...
    let msgs = conversation.messages.filter({ message in
...
public func latestValidMessageInRealm(_ realm: Realm) -> Message? {
    ...
    let latestMessage: Message? = [latestGroupMessage, latestOneToOneMessage].compactMap({ $0 }).sorted(by: { $0.createdUnixTime > $1.createdUnixTime }).first
...
public func latestUnreadValidMessageInRealm(_ realm: Realm, withConversationType conversationType: ConversationType) -> Message? {
    ...
    case .group: // Public for now
        let predicate = NSPredicate(format: "withGroup != nil AND withGroup.includeMe = true AND withGroup.groupType = %d", GroupType.public.rawValue)
        let pred = NSPredicate(format: "readed == false AND fromFriend.userID = %s", YepUserDefaults.userID.value ?? 0)
        let messages: [Message]? = realm.objects(Conversation.self).filter(predicate).sorted(byKeyPath: "updatedUnixTime", ascending: false).first?.messages.filter(pred).sorted(by: { $0.createdUnixTime > $1.createdUnixTime })
...
public func updateUserWithUserID(_ userID: String, useUserInfo userInfo: JSONDictionary, inRealm realm: Realm) {
    ...
    if let user = userWithUserID(userID, inRealm: realm) {
        ...
        if let lastSignInUnixTime = Date.getTimeInterval(userInfo["lastLoginAt"]) {
        ...
        if let avatarURLString = userInfo["avatar"] as? String {
        ...
        if let blogURLString = website?["url"] as? String {
            user.blogURLString = blogURLString
        }

        if let blogTitle = website?["title"] as? String {
