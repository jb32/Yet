...
public extension FileManager {
    ...
    class func yepAvatarURLWithName(_ name: String) -> URL? {
    ...
    class func saveAvatarImage(_ avatarImage: UIImage, withName name: String) -> URL? {
        ...
        if let avatarURL = yepAvatarURLWithName(name) {
            let imageData = avatarImage.jpegData(compressionQuality: 0.8)//UIImageJPEGRepresentation(avatarImage, 0.8)
    ...
    class func yepMessageCachesURL() -> URL? {
    ...
    class func yepMessageImageURLWithName(_ name: String) -> URL? {
    ...
    class func yepMessageAudioURLWithName(_ name: String) -> URL? {
    ...
    class func yepMessageVideoURLWithName(_ name: String) -> URL? {
