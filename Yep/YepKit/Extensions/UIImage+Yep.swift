...
public extension UIImage {
    ...
    func maskWithImage(_ maskImage: UIImage) -> UIImage {
    ...
    struct BubbleMaskImage {
        ...
        public static let leftTail: UIImage = {
            ...
            maskImage = maskImage.resizableImage(withCapInsets: UIEdgeInsets(top: 25, left: 27, bottom: 20, right: 20), resizingMode: UIImage.ResizingMode.stretch)
            return maskImage
        }()
        ...
        public static let rightTail: UIImage = {
            ...
            maskImage = maskImage.resizableImage(withCapInsets: UIEdgeInsets(top: 24, left: 20, bottom: 20, right: 27), resizingMode: UIImage.ResizingMode.stretch)
            return maskImage
        }()
    }

    func bubbleImageWithTailDirection(_ tailDirection: MessageImageTailDirection, size: CGSize, forMap: Bool = false) -> UIImage {
